...
export default defineConfig({
  ...
  use: {
    ...
    // Pass environment variables to the tests. Playwright automatically passes
    // variables from the process environment, so explicit passThrough might not be needed
    // unless isolating or transforming them.
    // env: {
